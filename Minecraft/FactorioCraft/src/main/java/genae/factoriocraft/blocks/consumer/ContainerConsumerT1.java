...
public class ContainerConsumerT1 extends Container {
    private TileEntityConsumerT1 te;
    private int energy;
    private int cookTime;
    private boolean cooking;

    public ContainerConsumerT1(IInventory playerInventory, TileEntityConsumerT1 te) {
        this.te = te;
        addOwnSlots();
    ...
    public ItemStack transferStackInSlot(EntityPlayer playerIn, int index) {
        ...
        if (slot != null && slot.getHasStack()) {
            ...
            if (index < TileEntityConsumerT1.SIZE) {
                if (!this.mergeItemStack(itemstack1, TileEntityConsumerT1.SIZE, this.inventorySlots.size(), true)) {
                    return ItemStack.EMPTY;
                }
            } else if (!this.mergeItemStack(itemstack1, 0, TileEntityConsumerT1.SIZE, false)) {
                return ItemStack.EMPTY;
            }
